...
export const getArticlesView = (state: StateSchema) => state.articlesPage?.view || 'SMALL';
...
export const getArticlesInited = (state: StateSchema) => state.articlesPage?.inited || false;
